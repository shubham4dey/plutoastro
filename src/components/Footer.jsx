    ...
    <div>
      <div className="flex justify-center items-start lg:px-12  md:px-12 px-4 lg:flex-row md:flex-row flex-row bg-purple-950 bg-opacity-80 lg:gap-10 md:gap-10 gap-16 lg:w-12/12 md:w-12/12 w-12/12 lg:py-16 md:py-16 py-10 pb-20 flex-wrap">
        <div className=" lg:w-3/12 w-6/12 md:w-3/12 ">
          <div className="flex justify-center items-center flex-col gap-2">
            <img 
              alt="logo" 
              className="lg:w-48 w-32 rounded-3xl md:w-40 drop-shadow-lg" 
              src={logo}
              style={{
            ...
            <div className="flex justify-evenly md:gap-4 gap-3 lg:gap-5 items-center flex-row mt-4">
              <Link
                target="_blank"
                to={"https://www.instagram.com/"}
              >
                <span className="text-white lg:text-2xl text-xl md:text-2xl hover:text-purple-400 transition-colors">
        ...
        <div className="lg:w-2/12 w-6/12 md:w-2/12">
      ...
      <div className="bg-purple-950 bg-opacity-95 text-white text-center py-5">
        <span className="tracking-wide">
          © 2026 All Rights Reserved Pluto Astro
        </span>
      </div>
    </div>
  );
