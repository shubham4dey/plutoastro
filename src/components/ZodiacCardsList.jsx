...
const ZodiacCardsList = () => {
  ...
  const cardClass = "lg:w-[22%] 2xl:w-[20%] w-full mb-4 lg:mb-0";
  ...
  return (
    <div className="flex flex-col w-full lg:mt-0 lg:mb-10 2xl:mb-16 justify-center items-center h-full relative">
      ...
      <div className="flex justify-center gap-4 lg:gap-10 items-center py-2 lg:py-3 w-full flex-wrap">
        <Link className={cardClass} to="/horoscope/Aries">
          <ZodiacCard name={lang[LangKey].Aries} value="Mar 21 - Apr 19" img={Aries} />
        </Link>

        <Link className={cardClass} to="/horoscope/Aquarius">
  ...
  >
    ...
    />
      ...
      <div className="flex justify-between items-center py-2 lg:py-3 w-full flex-wrap lg:px-12">
        <Link className={cardClass} to="/horoscope/Cancer">
          <ZodiacCard name={lang[LangKey].Cancer} value="Jun 21 - Jul 22" img={Cancer} />
        </Link>

        <Link className={cardClass} to="/horoscope/Leo">
      ...
      {/* ROW 4 */}
      <div className="flex justify-between items-center py-2 lg:py-3 w-full flex-wrap lg:px-12">
        <Link className={cardClass} to="/horoscope/Virgo">
          <ZodiacCard name={lang[LangKey].Virgo} value="Aug 23 - Sep 22" img={Virgo} />
        </Link>

        <Link className={cardClass} to="/horoscope/Libra">
  ...
  >
    ...
    />
      ...
      <div className="flex justify-center gap-4 lg:gap-10 items-center py-2 lg:py-3 w-full flex-wrap">
        ...
        <Link className={cardClass} to="/horoscope/Sagittarius">
          <ZodiacCard
