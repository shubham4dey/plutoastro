...
function AstrologersAdmin() {
  ...
  const fetchAstrologers = async () => {
    try {
      ...
      const res = await fetch(
        `http://plutoastro-api.onrender.com/api/admin/astrologers?page=${page}&search=${search}`,
        {
          headers: {
  ...
  const createAstrologer = async () => {
    ...
    try {
      ...
      const res = await fetch("http://plutoastro-api.onrender.com/api/admin/astrologer", {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const updateAstrologer = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `http://plutoastro-api.onrender.com/api/admin/astrologer/${editingId}`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const deleteAstrologer = async (id) => {
    ...
    try {
      const token = localStorage.getItem("adminToken");
      const res = await fetch(
        `http://plutoastro-api.onrender.com/api/admin/astrologer/${id}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const editAstrologer = (astro) => {
    ...
    setPreview(astro.image ? `http://plutoastro-api.onrender.com${astro.image}` : "");
    setShowModal(true);
  };
