...
function AIAstrologersAdmin() {
  ...
  const fetchAstrologers = async () => {
    try {
      const response = await fetch(
        "http://http://plutoastro-api.onrender.com/api/ai-astrologers/admin/all"
      );
  ...
  const deleteAstrologer = async (id) => {
    ...
    try {
      await fetch(
        `http://http://plutoastro-api.onrender.com/api/ai-astrologers/${id}`,
        {
          method: "DELETE",
        }
      );
  ...
  const toggleStatus = async (id) => {
    try {
      await fetch(
        `http://http://plutoastro-api.onrender.com/api/ai-astrologers/${id}/status`,
        {
          method: "PATCH",
        }
      );
